...
import "./FF.css";
// import img1 from "./ff-img/ff-main.png";
import img2 from "./ff-img/ff-2.webp";
...
export function Block3() {
    return (
      <>
        ...
        <p>If you would like to pay using Vodafone cash or Instapay app, please contact us on our social media pages or email us on info@leafanimals.com</p>
        </section>
      </>
    );
}